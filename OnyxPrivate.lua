...
local CustomBloodAmbienceSkyToggle = YesIdcTab:CreateToggle({
	Name = "BloodAmbience",
	CurrentValue = false,
	Flag = "VeryCoolIg", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
	Callback = function(GravityValue)
		if GravityValue then
